  ...
  data () {
    return {
      ...
      academies: [
                    ...
                    { label: '经济学院', value: 1 },
                    { label: '外国语学院', value: 2 },
                    { label: '物理与天文学院', value: 3 },
                    { label: '软件学院', value: 4 },
                    { label: '职业与继续教育学院', value: 5 },
                    { label: '历史与档案学院', value: 6 },
                    { label: '公共管理学院', value: 7 },
                    { label: '工商管理与旅游管理学院', value: 8 },
                    { label: '化学科学与工程学院', value: 9 },
                    { label: '资源环境与地球科学学院', value: 10 },
                    { label: '体育学院', value: 11 },
                    { label: '马克思主义学院', value: 12 },
                    { label: '新闻学院', value: 13 },
                    { label: '民族学与社会学学院', value: 14 },
                    { label: '艺术与设计学院', value: 15 },
                    { label: '生命科学学院', value: 16 },
                    { label: '建筑与规划学院', value: 17 },
                    { label: '医学院', value: 18},
                    { label: '生态与环境学院', value: 19 },
                    { label: '文学院', value: 20 },
                    { label: '法学院', value: 21 },
                    { label: '数学与统计学院', value: 22 },
                    { label: '信息学院', value: 23 },
                    { label: '国际学院', value: 24 },
                    { label: '农学院', value: 25 },
                    { label: '材料与能源学院', value: 26 },
                    { label: '昌新国际艺术学院', value: 27 },
                    { label: '大学外语教学部', value: 28 },
                    { label: '地球科学学院', value: 29 },
                    { label: '政府管理学院', value: 30 },
                    { label: '汉语国际教育学院', value: 31 },
                    { label: '资源植物研究院', value: 32 }
      ],
      new_threads: [],
      hot_threads: [],
      new_resources: [],
